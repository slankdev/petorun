...
ip netns exec bgp0 ip addr add 10.0.20.1/24 dev bgp0eth1
...
ip netns exec usr0 ip addr add 10.0.10.2/24 dev usr0eth0
...
ip netns exec usr1 ip addr add 10.0.20.2/24 dev usr1eth0
